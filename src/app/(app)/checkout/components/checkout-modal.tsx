...
const CheckoutModal = () => {
  ...
  return (
    <>
        <button className='w-full py-2 rounded-md mt-4' style={{backgroundColor:primaryColor,color:getContrastColor(primaryColor)}} onClick={()=>setOpen(true)}>اتمام عملية الشراء</button>
