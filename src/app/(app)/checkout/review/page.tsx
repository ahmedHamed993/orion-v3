          ...
          <Box>
            <div className="flex justify-between">
              ...
              <span className="font-bold text-slate-950">
                {checkoutData?.settings?.base_delivery_cost || 0}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-slate-600">وقت التوصيل</span>
              <span className="font-bold text-slate-950">
                {checkoutData?.settings?.order_delivery_time || 0}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-slate-600">سعر التوصيل للكيلو متر</span>
              <span className="font-bold text-slate-950">
                {checkoutData?.settings?.price_per_km || 0}
              </span>
            </div>
          </Box>
        </div>
        <div className="flex-1 flex flex-col gap-4">
          <Box>
            <div className="flex justify-between">
              ...
              <span className="font-bold text-slate-950">
                {checkoutData?.distance_in_km?.toFixed(2) || 0}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-slate-600">سعر التوصيل الاساسي</span>
              <span className="font-bold text-slate-950">
                {checkoutData?.original_delivery_cost?.toFixed(2) || 0}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-slate-600">اكرامية السائق</span>
              <span className="font-bold text-slate-950">
                {checkoutData?.driver_tip?.toFixed(2) || 0}
              </span>
            </div>
          </Box>
          ...
          <Box>
            <div className="flex justify-between">
              ...
              <span className="font-bold">
                {checkoutData?.address_details || "لا يوجد"}
              </span>
            </div>
            <div className="flex flex-col gap-2">
              <span className="text-slate-600">العنوان</span>
              <ViewLocation
                lat={checkoutData?.address_location?.coordinates?.[1]}
                lng={checkoutData?.address_location?.coordinates?.[0]}
              />
            </div>
          </Box>
        </div>
